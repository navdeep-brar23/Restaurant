...
const Menu = () => {
  ...
  const [showModal, setShowModal] = useState(false);  // Control the item modal
  const [showCart, setShowCart] = useState(false);    // Control the cart modal
  ...
  const [spiciness, setSpiciness] = useState("Mild"); // Spiciness for the selected item
  ...
  return (
    <div className="menu-container">
      ...
      {/* Menu Items */}
      <div className="dish-container"> {/* Updated this to use dish-container class */}
        {filteredItems.map(item => (
          <div className="dish-card" key={item.id}> {/* Updated to use dish-card class */}
